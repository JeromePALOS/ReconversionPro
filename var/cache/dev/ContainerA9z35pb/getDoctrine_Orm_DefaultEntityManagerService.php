...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\PF\\AgendaBundle\\Entity')));

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver($b, 'AppBundle\\Entity');
$c->addDriver($b, 'PF\\AgendaBundle\\Entity');
...
$d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'PFAgendaBundle' => 'PF\\AgendaBundle\\Entity'));
